...
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/films.js */ "./src/model/films.js");
/* harmony import */ var _model_comment_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../model/comment.js */ "./src/model/comment.js");
...
class Api {
  ...
  getFilms() {
    return this._load({url: `movies`})
      .then(Api.toJSON)
      .then((films) => films.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    return this._load({
      url: `movies/${film.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }

  getComments(film) {
    return this._load({url: `comments/${film.id}`})
    .then(Api.toJSON)
    .then((comments) => comments.map(_model_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToClient));
  }
  ...
  addComment(film, comment) {
    return this._load({
      ...
      method: Method.POST,
      body: JSON.stringify(_model_comment_js__WEBPACK_IMPORTED_MODULE_1__["default"].adaptToServer(comment)),
      headers: new Headers({"Content-Type": `application/json`})
    })
      .then(Api.toJSON)
      .then((response) => {
  ...
  getFilms() {
    if (Provider.isOnline()) {
      return this._api.getFilms()
        .then((films) => {
          const items = createStoreStructure(films.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
    ...
    return Promise.resolve(storeFilms.map(_model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateFilm(film) {
    if (Provider.isOnline()) {
      return this._api.updateFilm(film)
        .then((updatedFilm) => {
          this._store.setItem(updatedFilm.id, _model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedFilm));
          return updatedFilm;
        });
    }

    this._store.setItem(film.id, _model_films_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(Object.assign({}, film)));
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: UserRank, SortType, UserAction, UpdateType, FilterType, MainNavigationItem, StatisticsPeriod */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MainNavigationItem", function() { return MainNavigationItem; });
...
/* harmony import */ var _presenter_mainNavigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./presenter/mainNavigation.js */ "./src/presenter/mainNavigation.js");
/* harmony import */ var _presenter_filmList_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/filmList.js */ "./src/presenter/filmList.js");
/* harmony import */ var _model_filter_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/filter.js */ "./src/model/filter.js");
/* harmony import */ var _model_films_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/films.js */ "./src/model/films.js");
/* harmony import */ var _model_comment_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/comment.js */ "./src/model/comment.js");
...
const api = new _api_api_js__WEBPACK_IMPORTED_MODULE_9__["default"](END_POINT, AUTHORIZATION);
...
const filmsModel = new _model_films_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const commentsModel = new _model_comment_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const filmListPresenter = new _presenter_filmList_js__WEBPACK_IMPORTED_MODULE_3__["default"](siteMainElement, filmsModel, commentsModel, filterModel, api, apiWithProvider);
const mainNavigationPresenter = new _presenter_mainNavigation_js__WEBPACK_IMPORTED_MODULE_2__["default"](siteMainElement, filterModel, filmsModel, filmListPresenter);
...
apiWithProvider.getFilms()
  .then((films) => {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmsModel.getFilms()), _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteFooterStatisticsElement, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel.getFilms()), _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
  })
  .catch(() => {
    filmsModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT, []);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmsModel.getFilms()), _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteFooterStatisticsElement, new _view_footer_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel.getFilms()), _utils_render_js__WEBPACK_IMPORTED_MODULE_7__["RenderPosition"].BEFOREEND);
  });
...
class Film {
  ...
  renderFilmCard(film) {
    ...
    this._filmComponent = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._film);
  ...
  showFilmDetails() {
    ...
    this._filmDetailsComponent = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._film, this._comments);
...
/* harmony import */ var _view_films_board_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/films-board.js */ "./src/view/films-board.js");
...
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
/* harmony import */ var _view_no_film_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/no-film.js */ "./src/view/no-film.js");
/* harmony import */ var _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../view/films-list-container.js */ "./src/view/films-list-container.js");
...
/* harmony import */ var _view_rated_films_list_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/rated-films-list.js */ "./src/view/rated-films-list.js");
/* harmony import */ var _view_commented_films_list_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../view/commented-films-list.js */ "./src/view/commented-films-list.js");
/* harmony import */ var _film_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./film.js */ "./src/presenter/film.js");
...
/* harmony import */ var _utils_filter_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/filter.js */ "./src/utils/filter.js");
...
class MovieList {
  constructor(boardContainer, filmsModel, commentsModel, filterModel, api, apiWithProvider) {
    ...
    this._filmsBoard = new _view_films_board_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._filmsList = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._filmsListComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._ratedFilmsList = new _view_rated_films_list_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
    this._ratedFilmsListComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._commentedFilmsList = new _view_commented_films_list_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
    this._commentedFilmsListComponent = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._loadingComponent = new _view_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  _getFilms() {
    ...
    const filtredFilms = _utils_filter_js__WEBPACK_IMPORTED_MODULE_12__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["SortType"].DATE:
        return filtredFilms.slice().sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmData"]);
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["SortType"].RATING:
        return filtredFilms.slice().sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_11__["sortFilmRating"]);
    }
    return filtredFilms;
  }
  ...
  _handleViewAction(actionType, updateType, updateFilm, updateComment) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["UserAction"].UPDATE_FILM:
        this._apiWithProvider.updateFilm(updateFilm).then((response) => {
          this._filmsModel.updateFilm(updateType, response);
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["UserAction"].ADD_COMMENT:
        this._filmPresenter[updateFilm.id].setViewState(_film_js__WEBPACK_IMPORTED_MODULE_9__["State"].SAVING);
        ...
        .catch(() => {
          this._filmPresenter[updateFilm.id].setViewState(_film_js__WEBPACK_IMPORTED_MODULE_9__["State"].ABORTING_ADD, updateComment.id);
        });
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["UserAction"].DELETE_COMMENT:
        this._filmPresenter[updateFilm.id].setViewState(_film_js__WEBPACK_IMPORTED_MODULE_9__["State"].DELETING, updateComment.id);
        ...
        .then((response) => this._filmsModel.updateFilm(updateType, response)))
        .catch(() => {
          this._filmPresenter[updateFilm.id].setViewState(_film_js__WEBPACK_IMPORTED_MODULE_9__["State"].ABORTING_DELETE, updateComment.id);
        });
        break;
    }
  }
  ...
  _handleModelEvent(updateType) {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["UpdateType"].MAJOR:
        ...
        this._renderBoard();
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_13__["UpdateType"].INIT:
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._boardContainer, this._sortComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderFilm(film, filmListContainer, modes) {
    const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_9__["default"](filmListContainer, this._handleViewAction, this._handleModeChange, this._commentsModel, this._api);
  ...
  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._boardContainer, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }

  _renderNoFilm() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._boardContainer, this._noFilmComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderShowMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsList, this._showMoreButtonComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderRatedFilmList() {
    ...
    if (ratingsNotZero) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._ratedFilmsList);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._ratedFilmsListComponent);
    }
  }
  ...
  _renderCommentedFilmList() {
    ...
    if (commentsNotZero) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._commentedFilmsList);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._commentedFilmsListComponent);
    }
  }
  ...
  _clearBoard({resetRenderedFilmCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._noFilmComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._showMoreButtonComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._filmsBoard);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._filmsList);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._filmsListComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._ratedFilmsList);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._ratedFilmsListComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._commentedFilmsList);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["remove"])(this._commentedFilmsListComponent);
  ...
  _renderBoard() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._boardContainer, this._filmsBoard, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsBoard, this._filmsList, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsList, this._filmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsBoard, this._ratedFilmsList, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._ratedFilmsList, this._ratedFilmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._filmsBoard, this._commentedFilmsList, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_10__["render"])(this._commentedFilmsList, this._commentedFilmsListComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_10__["RenderPosition"].BEFOREEND);
...
/***/ "./src/presenter/mainNavigation.js":
/*!*****************************************!*\
  !*** ./src/presenter/mainNavigation.js ***!
  \*****************************************/
/*! exports provided: default */
...
class MainNavigation {
  constructor(MainNavigationContainer, filterModel, filmsModel, filmListPresenter) {
    ...
    this._currentNavigationItem = _const_js__WEBPACK_IMPORTED_MODULE_4__["MainNavigationItem"].FILMS;
  ...
  init() {
    ...
    this._mainNavigationComponent = new _view_main_navigation_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter, this._currentNavigationItem);
    ...
    if (prevMainNavigationComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._MainNavigationContainer, this._mainNavigationComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._mainNavigationComponent, prevMainNavigationComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevMainNavigationComponent);
  }
  ...
  _handleFilterTypeClick(filterType) {
    ...
    this._filterModel.setFilter(_const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MAJOR, filterType);
  }

  _handleMainNavigationClick(mainNavigationItem) {
    switch (mainNavigationItem) {
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["MainNavigationItem"].FILMS:
        this._currentNavigationItem = _const_js__WEBPACK_IMPORTED_MODULE_4__["MainNavigationItem"].FILMS;
        this.init();
        this._filmListPresenter.init();
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._statisticsComponent);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_4__["MainNavigationItem"].STATISTICS:
        this._currentNavigationItem = _const_js__WEBPACK_IMPORTED_MODULE_4__["MainNavigationItem"].STATISTICS;
        this.init();
        this._filmListPresenter.destroy();
        this._statisticsComponent = new _view_statistics_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._filmsModel.getFilms());
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._MainNavigationContainer, this._statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
        break;
    }
  }
  ...
  _getFilters() {
    ...
    return [
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].ALL,
        name: `All movies`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].ALL](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].WATCHLIST](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].HISTORY,
        name: `History`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].HISTORY](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_4__["FilterType"].FAVORITES](films).length
      }
    ];
  }
}
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: sortFilmData, sortFilmRating, formatDuration, formatReleaseDate, formatCommentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortFilmData", function() { return sortFilmData; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "formatReleaseDate", function() { return formatReleaseDate; });
...
const sortFilmData = (filmA, filmB) => {
...
const formatDuration = (filmDuration) => {

  return moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(`day`).add(filmDuration, `minutes`).format(`H[h] m[m]`);
};

const formatReleaseDate = (releaseDate, justYear = false) => {
  if (!(releaseDate instanceof Date)) {
    return ``;
  }

  if (justYear) {
    return moment__WEBPACK_IMPORTED_MODULE_0___default()(releaseDate).format(`YYYY`);
  }

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(releaseDate).format(`DD MMMM YYYY`);
};
...
const formatCommentDate = (commentDate) => {
  ...
  if (Math.abs(moment__WEBPACK_IMPORTED_MODULE_0___default()().diff(commentDate, `s`)) < 5) {
    return `now`;
  }
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(commentDate).fromNow();
};
...
const filter = {
  ...
  [_const__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (films) => films.filter((film) => film.addToWatchlist),
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getWatchedFilmsDuringPeriod, getUserRank, makeItemsUniq, countFilmsByGenre, getGenres, getSortedGenres */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchedFilmsDuringPeriod", function() { return getWatchedFilmsDuringPeriod; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getUserRank", function() { return getUserRank; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "makeItemsUniq", function() { return makeItemsUniq; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "countFilmsByGenre", function() { return countFilmsByGenre; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGenres", function() { return getGenres; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getSortedGenres", function() { return getSortedGenres; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
...
const getWatchedFilmsDuringPeriod = (films, period) => {
  const watchedFilms = _utils_filter_js__WEBPACK_IMPORTED_MODULE_1__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].HISTORY](films);

  if (period === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticsPeriod"].ALL_TIME.value) {
    return watchedFilms;
  }

  const periodTime = moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf(period);
  const filteredFilms = watchedFilms.filter((film) => moment__WEBPACK_IMPORTED_MODULE_0___default()(periodTime).isBefore(film.watchingDate));

  return filteredFilms;
};

const getUserRank = (films) => {
  const watchedFilms = getWatchedFilmsDuringPeriod(films, _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticsPeriod"].ALL_TIME.value);
  const watchedFilmsCount = watchedFilms.length;

  if (watchedFilmsCount >= 1 && watchedFilmsCount <= 10) {
    return _const_js__WEBPACK_IMPORTED_MODULE_2__["UserRank"].NOVICE;
  } else if (watchedFilmsCount >= 11 && watchedFilmsCount <= 20) {
    return _const_js__WEBPACK_IMPORTED_MODULE_2__["UserRank"].FAN;
  } else if (watchedFilmsCount > 20) {
    return _const_js__WEBPACK_IMPORTED_MODULE_2__["UserRank"].MOVIE_BUFF;
  }
  return _const_js__WEBPACK_IMPORTED_MODULE_2__["UserRank"].ZERO;
};
...
/***/ "./src/view/commented-films-list.js":
/*!******************************************!*\
  !*** ./src/view/commented-films-list.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentedFilmsList; });
...
class CommentedFilmsList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
  ...
  return (
    `<article class="film-card">
      ...
      <p class="film-card__info">
        <span class="film-card__year">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["formatReleaseDate"])(releaseDate, true)}</span>
        <span class="film-card__duration">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_1__["formatDuration"])(duration)}</span>
...
const createCommentsTemplate = (filmId, comment) => {
  ...
  return `<li class="film-details__comment" data-comment-id="${id}">
            ...
            <div>
              <p class="film-details__comment-text">${text ? he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(text) : ``}</p>
              <p class="film-details__comment-info">
                <span class="film-details__comment-author">${author}</span>
                <span class="film-details__comment-day">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_2__["formatCommentDate"])(date)}</span>
...
const createEmojiElement = (emoji) => {
  return Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["createElement"])(createEmojiTemplate(emoji));
};
            ...
            <div class="film-details__info">
              ...
              <table class="film-details__table">
                ...
                <tr class="film-details__row">
                  ...
                  <td class="film-details__cell">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_2__["formatReleaseDate"])(releaseDate)}</td>
                </tr>
                <tr class="film-details__row">
                  <td class="film-details__term">Runtime</td>
                  <td class="film-details__cell">${Object(_utils_film_js__WEBPACK_IMPORTED_MODULE_2__["formatDuration"])(duration)}</td>
                </tr>
                <tr class="film-details__row">
          ...
          <section class="film-details__comments-wrap">
            ...
            <div class="film-details__new-comment">
              ...
              <label class="film-details__comment-label">
                <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment"}>${textComment ? he__WEBPACK_IMPORTED_MODULE_0___default.a.encode(textComment) : ``}</textarea>
              </label>
...
class FilmDetails extends _smart_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
...
const createFilterItemTemplate = (filter, currentFilterType, currentNavigationItem) => {
  ...
  return `<a href="#${type}" class="main-navigation__item ${type === currentFilterType && currentNavigationItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].FILMS ? `main-navigation__item--active` : ``}" data-filter-type="${type}" data-navigation-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].FILMS}">${name} ${countFilms}</a>`;
};
  ...
  return (
    `<nav class="main-navigation">
      <div class="main-navigation__items">
        <a href="#all" class="main-navigation__item ${currentFilterType === `all` && currentNavigationItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].FILMS ? `main-navigation__item--active` : ``}" data-filter-type="all" data-navigation-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].FILMS}">All movies</a>
        ${filterItemsTemplate}
      </div>
      <a href="#stats" class="main-navigation__additional ${currentNavigationItem === _const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].STATISTICS ? `main-navigation__item--active` : ``}" data-navigation-item="${_const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].STATISTICS}">Stats</a>
    </nav>`
  );
};
...
class MainNavigation extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _filterTypeClickHandler(evt) {
    if (evt.target.tagName !== `A` || evt.target.dataset.navigationItem !== _const_js__WEBPACK_IMPORTED_MODULE_1__["MainNavigationItem"].FILMS) {
      return;
    }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return RatedFilmsList; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
...
class RatedFilmsList extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
class LoadMoreButton extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
const renderChart = (statisticCtx, films) => {
  ...
  const sortedGenres = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["getSortedGenres"])(films);
  const sortedCounts = sortedGenres.map((genre) => Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["countFilmsByGenre"])(films, genre));

  statisticCtx.height = BAR_HEIGHT * sortedGenres.length;

  return new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(statisticCtx, {
...
const createStatisticsTemplate = (films, watchedFilms, currentStatisticsPeriod) => {
  ...
  for (const period in _const_js__WEBPACK_IMPORTED_MODULE_4__["StatisticsPeriod"]) {
    if (period) {
      statisticsFiltersTemplate += createStatisticsFilterTemplate(_const_js__WEBPACK_IMPORTED_MODULE_4__["StatisticsPeriod"][period], currentStatisticsPeriod);
    }
  }
  ...
  const topGenre = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["getSortedGenres"])(watchedFilms)[0];

  return `<section class="statistic">
    <p class="statistic__rank">
      Your rank
      <img class="statistic__img" src="images/bitmap@2x.png" alt="Avatar" width="35" height="35">
      <span class="statistic__rank-label">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["getUserRank"])(films)}</span>
    </p>
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(films) {
    super();
    ...
    this._currentStatisticsPeriod = _const_js__WEBPACK_IMPORTED_MODULE_4__["StatisticsPeriod"].ALL_TIME.value;
  ...
  _getWatchedFilms() {
    this._watchedFilms = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_3__["getWatchedFilmsDuringPeriod"])(this._films, this._currentStatisticsPeriod);
  }
...
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/statistics.js */ "./src/utils/statistics.js");
...
const createUserProfileTemplate = (films) => {
  return (
    `<section class="header__profile profile">
      <p class="profile__rating">${Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getUserRank"])(films)}</p>
